...
import static engine.GameDifficulty.NORMAL;
import static engine.GameDifficulty.getDiffculty;
...
class DifficultyScreenTest {
    ...
    @Test
    void chooseDifficulty_normal_test() throws IOException {
        try {
        ...
        //when pressed DIFFICULTY normal and then back to main
        int _difficulty=getDiffculty();
        //returns normal
        assertEquals(_difficulty,NORMAL);  // difficulty normal
    }
}
