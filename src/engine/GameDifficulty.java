    ...
    public static void setDifficulty(int difficulty){
        ...
        switch (GameDifficulty.selectedGameDifficulty) {
            case EASY:
                ...
                levelSettingsList.add(new LevelSettings(4, 3, 60, 2000));
                /** Difficulty settings for level 2. */
                levelSettingsList.add(new LevelSettings(4, 4, 50, 2500));
                /** Difficulty settings for level 3. */
                levelSettingsList.add(new LevelSettings(5, 4, 40, 1500));
                /** Difficulty settings for level 4. */
                levelSettingsList.add(new LevelSettings(5, 5, 30, 1500));
                /** Difficulty settings for level 5. */
                levelSettingsList.add(new LevelSettings(6, 5, 20, 1000));
                /** Difficulty settings for level 6. */
                levelSettingsList.add(new LevelSettings(6, 6, 10, 1000));
                /** Difficulty settings for level 7. */
                levelSettingsList.add(new LevelSettings(7, 6, 2, 500));
                break;
            case NORMAL:
                /** Fill level 1 ~ 7 */
